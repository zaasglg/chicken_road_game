var SETTINGS = {
    ...
    chance: {
        easy: [ 7, 20 ],      // Easy: ловушка на 7-20 секторе (легко)
        medium: [ 3, 12 ],    // Medium: ловушка на 3-12 секторе (сложнее)
        hard: [ 2, 8 ],       // Hard: ловушка на 2-8 секторе (очень сложно)
        hardcore: [ 2, 6 ]    // Hardcore: ловушка на 2-6 секторе (экстремально)
    },
