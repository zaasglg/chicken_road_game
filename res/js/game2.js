var SETTINGS = {
    ...
    chance: {
        easy: [ 7, 30 ],      // Easy: ловушка на 7-30 секторе (легко)
        medium: [ 3, 15 ],    // Medium: ловушка на 3-15 секторе (сложнее)
        hard: [ 2, 10 ],      // Hard: ловушка на 2-10 секторе (очень сложно)
        hardcore: [ 2, 8 ]    // Hardcore: ловушка на 2-8 секторе (экстремально)
    },
